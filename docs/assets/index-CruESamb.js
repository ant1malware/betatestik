const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-DAM4pDiW.js","assets/react-vendor-Bk42iPUi.js","assets/icons-692LNvI8.js","assets/VoteWidget-SQZRMKra.js","assets/asset-ClJDRudC.js","assets/WhatsNew-p258BbBD.js","assets/DiffPage-D7iYesNp.js","assets/LiquidGlassShowcase-C6z-Buym.js","assets/PrintSheet-DPt895i7.js","assets/RolePage-GqB__Iha.js","assets/FavStar-Dyjstyjc.js","assets/LawPage-CIFfSM47.js","assets/VuPage-C1zG0njd.js","assets/BuddyPlayground-D4gGuPEP.js","assets/SettingsPage-CvQVJydu.js","assets/FavoritesPage-Du4ac1W5.js"])))=>i.map(i=>d[i]);
import{r as ut,a as mt,R as c,L as A,u as pt,b as H,B as ht,c as xt,d as L,N as pe}from"./react-vendor-Bk42iPUi.js";import{S as gt,A as ft,M as Y,a as X,B as bt,N as yt,b as wt,U as J,C as jt,c as vt,E as kt,I as ze,d as Nt,Q as St,R as Et,e as G,f as le,H as zt,g as ce,X as Ie,h as de,G as It,i as _t,F as Mt,L as Lt,j as Ct,k as At,l as Rt,m as Pt,n as $t}from"./icons-692LNvI8.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(r){if(r.ep)return;r.ep=!0;const l=n(r);fetch(r.href,l)}})();var _e={exports:{}},Q={};/**
 * @license React
 ...
 */var Tt=ut,Dt=Symbol.for("react.element"),Bt=Symbol.for("react.fragment"),Ft=Object.prototype.hasOwnProperty,Ot=Tt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Kt={key:!0,ref:!0,__self:!0,__source:!0};function Me(t,s,n){var a,r={},l=null,i=null;n!==void 0&&(l=""+n),s.key!==void 0&&(l=""+s.key),s.ref!==void 0&&(i=s.ref);for(a in s)Ft.call(s,a)&&!Kt.hasOwnProperty(a)&&(r[a]=s[a]);if(t&&t.defaultProps)for(a in s=t.defaultProps,s)r[a]===void 0&&(r[a]=s[a]);return{$$typeof:Dt,type:t,key:l,ref:i,props:r,_owner:Ot.current}}Q.Fragment=Bt;Q.jsx=Me;Q.jsxs=Me;_e.exports=Q;var e=_e.exports,oe={},he=mt;oe.createRoot=he.createRoot,oe.hydrateRoot=he.hydrateRoot;const qt="modulepreload",Vt=function(t){return"/betatestik/"+t},xe={},T=function(s,n,a){let r=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));r=Promise.allSettled(n.map(u=>{if(u=Vt(u),u in xe)return;xe[u]=!0;const f=u.endsWith(".css"),w=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${w}`))return;const x=document.createElement("link");if(x.rel=f?"stylesheet":qt,f||(x.as="script"),x.crossOrigin="",x.href=u,o&&x.setAttribute("nonce",o),document.head.appendChild(x),f)return new Promise((S,E)=>{x.addEventListener("load",S),x.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${u}`)))})}))}function l(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return r.then(i=>{for(const o of i||[])o.status==="rejected"&&l(o.reason);return s().catch(l)})},ee=800,ge="chat:nick",fe=["Скай-Страж","Право-Самурай","Пульс-Рейдер","Кибер-Медик","Неон-Тактик","Астрал-Офицер","Фантом-Лечащий","Шифр-Инспектор","Квант-Боец","Пиксель-Волк","Туман-Командор","Искра-Наблюдатель","Нуль-Гравитация","Полярный Пилот","Городской Хирург","Сыворотка-Vibe","Стерильный Ниндзя","Скальпель-Облако","Рентген-Панк","Ватка-Supreme"];function be(){const t=fe[Math.floor(Math.random()*fe.length)],s=Math.floor(Math.random()*900+100);return`${t} #${s}`}function Wt(t){try{return typeof t=="string"?JSON.parse(t):t instanceof ArrayBuffer?JSON.parse(new TextDecoder().decode(t)):(typeof Blob<"u"&&t instanceof Blob,null)}catch{return null}}function Ut(t){return new Date(t).toLocaleTimeString(void 0,{hour12:!1})}const Gt=`
...
`,rs=[{id:"gov",title:"Внутренний устав Правительства",text:as,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],Le="ui:density",Ce="ui:font",is="ui:features",Ae="ui:shadow",Re="ui:radius",Pe="ui:glass",$e="ui:readw",Te="ui:anim";function os(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),localStorage.setItem(Le,t)}function ls(){return localStorage.getItem(Le)==="compact"?"compact":"standard"}function cs(t){const s=Math.max(.9,Math.min(1.3,t)),n=16*s;document.documentElement.style.setProperty("--font-size",`${n}px`),localStorage.setItem(Ce,String(s))}function ds(){const t=parseFloat(localStorage.getItem(Ce)||"1");return isFinite(t)&&t>.6&&t<2?t:1}function us(t,s=!0){const n=ms();return t in n?!!n[t]:s}function ms(){try{const t=localStorage.getItem(is);return t?JSON.parse(t):{}}catch{return{}}}function ps(t){let s="none";t==="soft"&&(s="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(s="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",s),localStorage.setItem(Ae,t)}function hs(){const t=localStorage.getItem(Ae);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function xs(t){let s=8,n=16,a=20;t==="subtle"&&(s=6,n=10,a=14),t==="rounded"&&(s=12,n=18,a=24),document.documentElement.style.setProperty("--radius-lg",s+"px"),document.documentElement.style.setProperty("--radius-2xl",n+"px"),document.documentElement.style.setProperty("--radius-3xl",a+"px"),localStorage.setItem(Re,t)}function gs(){const t=localStorage.getItem(Re);return t==="subtle"||t==="rounded"?t:"standard"}function fs(t){const s=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",s+"px"),localStorage.setItem(Pe,String(s))}function bs(){const t=parseInt(localStorage.getItem(Pe)||"6",10);return isFinite(t)?t:6}function ys(t){const s=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",s+"ch"),localStorage.setItem($e,String(s))}function ws(){const t=parseInt(localStorage.getItem($e)||"78",10);return isFinite(t)?t:78}function js(){try{os(ls()),cs(ds()),ps(hs()),xs(gs()),fs(bs()),ys(ws()),vs(ks())}catch{}}function vs(t){document.documentElement.classList.toggle("anim-off",!t);try{localStorage.setItem(Te,t?"1":"0")}catch{}}function ks(){try{return localStorage.getItem(Te)!=="0"}catch{return!0}}const De={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},C={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function Be(...t){return t.filter(Boolean).join(" ")}function Fe(){const[t,s]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const n=window.matchMedia("(prefers-reduced-motion: reduce)"),a=r=>s(r.matches);return s(n.matches),typeof n.addEventListener=="function"?(n.addEventListener("change",a),()=>n.removeEventListener("change",a)):typeof n.addListener=="function"?(n.addListener(a),()=>n.removeListener(a)):()=>{}},[]),t}function Oe(t,s){c.useEffect(()=>{const n=t.current;if(!n)return;if(!s){n.style.setProperty("--lg-x","72%"),n.style.setProperty("--lg-y","18%");return}let a=0,r=72,l=18;const i=()=>{a=0;const f=t.current;f&&(f.style.setProperty("--lg-x",`${r}%`),f.style.setProperty("--lg-y",`${l}%`))},o=f=>{const w=t.current;if(!w)return;const x=w.getBoundingClientRect(),S=(f.clientX-x.left)/x.width*100,E=(f.clientY-x.top)/x.height*100;r=Math.max(0,Math.min(100,S)),l=Math.max(0,Math.min(100,E)),a||(a=window.requestAnimationFrame(i))},u=()=>{r=72,l=18,a||(a=window.requestAnimationFrame(i))};return n.addEventListener("pointermove",o,{passive:!0}),n.addEventListener("pointerdown",o,{passive:!0}),n.addEventListener("pointerenter",o,{passive:!0}),n.addEventListener("pointerleave",u),()=>{a&&window.cancelAnimationFrame(a),n.removeEventListener("pointermove",o),n.removeEventListener("pointerdown",o),n.removeEventListener("pointerenter",o),n.removeEventListener("pointerleave",u)}},[t,s])}function we(t){if(!t)return[255,255,255];const s=t.split(/\s+/).map(n=>Math.max(0,Math.min(255,Number(n))));return[s[0]??255,s[1]??255,s[2]??255]}function U(t){return`${t[0]} ${t[1]} ${t[2]}`}function se(t,s,n){return Math.round(t+(s-t)*n)}function je(t,s){return[se(t[0],s>=0?255:0,Math.abs(s)),se(t[1],s>=0?255:0,Math.abs(s)),se(t[2],s>=0?255:0,Math.abs(s))]}function Ns(t,s,n){const a=t?De[t]:s??C.tint,r=n??C.accent,l=we(a),i=we(r),o=je(i,.25),u=je(i,-.55);return{tintRgb:U(l),accentRgb:U(i),accentSoftRgb:U(o),accentDeepRgb:U(u)}}function Ke(t,s){const n={...t??{}},{tintRgb:a,accentRgb:r,accentSoftRgb:l,accentDeepRgb:i}=Ns(s.tone,s.tint,s.accent);return n["--lg-blur"]=`${s.blur}px`,n["--lg-tint"]=a,n["--lg-opacity"]=`${s.opacity}`,n["--lg-gloss"]=`${s.gloss}`,n["--lg-border"]=`${s.border}`,n["--lg-elev"]=`${s.elevation}`,n["--lg-glints"]=s.glints?"1":"0",n["--lg-accent"]=r,n["--lg-accent-soft"]=l,n["--lg-accent-deep"]=i,n}const qe=c.forwardRef((t,s)=>{const{blur:n=C.blur,tint:a=C.tint,opacity:r=C.opacity,gloss:l=C.gloss,border:i=C.border,glints:o=C.glints,interactive:u=C.interactive,animate:f=C.animate,elevation:w=C.elevation,tone:x,accent:S=C.accent,className:E,style:b,children:p,...j}=t,d=Fe(),g=u&&!d,h=c.useRef(null),m=c.useCallback(v=>{h.current=v,typeof s=="function"?s(v):s&&(s.current=v),v&&(v.style.setProperty("--lg-x","72%"),v.style.setProperty("--lg-y","18%"))},[s]);Oe(h,g);const y=c.useMemo(()=>Ke(b,{blur:n,tint:a,opacity:r,gloss:l,border:i,elevation:w,glints:o,tone:x,accent:S}),[b,n,a,r,l,i,w,o,x,S]),N={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*w}px ${50*w}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return e.jsxs("div",{ref:m,className:Be("liquid-glass",E),"data-animate":f?"true":"false","data-interactive":g?"true":"false",style:{...N,...y},...j,children:[e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),o&&e.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),e.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),g&&e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),e.jsx("div",{style:{position:"relative",zIndex:10},children:p}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:i,pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});qe.displayName="LiquidGlass";const Ve=c.forwardRef((t,s)=>{const{className:n,style:a,children:r,type:l,blur:i,tint:o,opacity:u,gloss:f,border:w,glints:x,interactive:S,animate:E,elevation:b,tone:p,accent:j=C.accent,...d}=t,g=i??C.blur,h=p?De[p]:o??C.tint,m=u??.16,y=f??.9,N=w??.6,v=x??!1,R=S??!0,z=b??1,k=Fe(),M=R&&!k,I=c.useRef(null),B=c.useCallback(_=>{I.current=_,typeof s=="function"?s(_):s&&(s.current=_),_&&(_.style.setProperty("--lg-x","70%"),_.style.setProperty("--lg-y","16%"))},[s]);Oe(I,M);const P=c.useMemo(()=>Ke(a,{blur:g,tint:h,opacity:m,gloss:y,border:N,glints:v,elevation:z,tone:p,accent:j}),[a,g,h,m,y,N,v,z,p,j]),$={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*z}px ${18*z}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return e.jsxs("button",{ref:B,type:l??"button",className:Be("liquid-glass liquid-glass__button",n),style:{...$,...P},...d,onMouseDown:_=>{_.currentTarget.style.transform="scale(0.985)"},onMouseUp:_=>{_.currentTarget.style.transform=""},onMouseLeave:_=>{_.currentTarget.style.transform=""},children:[e.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[e.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),e.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),e.jsx("span",{style:{position:"relative",zIndex:1},children:r}),e.jsx("style",{children:`
      ...
      `})]})});Ve.displayName="LiquidGlass.Button";const W=qe;W.Button=Ve;const We="theme",Ue="accent",Ge="accent_custom",He="bg",Ss="bg_custom",Ye="ui:style-mode",ne="ui:liquid:prev-theme",Xe="ui:liquid:tone",Je={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var Se,Ee;const ae=((Ee=(Se=import.meta)==null?void 0:Se.env)==null?void 0:Ee.BASE_URL)??"/",q=t=>{const s=t.replace(/^\/+/,"");return(ae.endsWith("/")?ae:ae+"/")+s},Qe={bg1:q("img/bg1.png"),bg2:q("img/bg2.png"),bg3:q("img/bg3.png"),bg4:q("img/bg4.png"),bg5:q("img/bg5.png")};function Ze(){const t=localStorage.getItem(We);return t==="light"||t==="dark"?t:null}function Es(){const t=localStorage.getItem(Ue);return t?t==="custom"?"custom":t in Je?t:null:null}function zs(){return localStorage.getItem(Ge)}function et(){const t=localStorage.getItem(He);return t&&(t==="none"||t==="custom"||t in Qe)?t:null}function Is(){return localStorage.getItem(Ss)}function tt(){const t=localStorage.getItem(Ye);return t==="classic"||t==="liquid"||t==="beta"?t:null}function _s(){return(localStorage.getItem(Xe)||"dark")==="light"?"light":"dark"}function Ms(t){try{localStorage.setItem(Xe,t)}catch{}const s=document.documentElement;if(s.classList.toggle("liquid-light",t==="light"),s.classList.toggle("liquid-dark",t!=="light"),s.classList.contains("theme-liquid"))try{ue(t==="light"?"light":"dark")}catch{}}function st(t){const s=document.documentElement;if(s.classList.toggle("theme-liquid",t==="liquid"),s.classList.toggle("theme-beta",t==="beta"),s.dataset.styleMode=t,t==="liquid"||t==="beta"){try{const n=Ze()??(nt()?"dark":"light");localStorage.setItem(ne,n);const a=_s();Ms(a)}catch{}try{const n=document.body;n.style.removeProperty("background"),n.style.removeProperty("background-size"),n.style.removeProperty("background-repeat"),n.style.removeProperty("background-attachment"),n.style.removeProperty("background-position")}catch{}}else{try{const n=localStorage.getItem(ne);(n==="light"||n==="dark")&&ue(n),localStorage.removeItem(ne)}catch{}try{const n=et()??"none";rt(n)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}try{localStorage.setItem(Ye,t)}catch{}}function nt(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function ue(t){const s=document.documentElement;t==="dark"?s.classList.add("dark"):s.classList.remove("dark"),localStorage.setItem(We,t);const n=t==="dark"?"#0a0a0a":"#fafafa";let a=document.querySelector('meta[name="theme-color"]');a||(a=document.createElement("meta"),a.name="theme-color",document.head.appendChild(a)),a.setAttribute("content",n);try{s.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function at(t){if(t==="custom"){const s=zs()||"#6366F1";document.documentElement.style.setProperty("--accent",s);const n=Cs(s,-.15);document.documentElement.style.setProperty("--accent-600",n)}else{const s=Je[t];document.documentElement.style.setProperty("--accent",s[500]),document.documentElement.style.setProperty("--accent-600",s[600])}localStorage.setItem(Ue,t)}function un(t){localStorage.setItem(Ge,it(t)),at("custom")}function rt(t){const s=document.body,a=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")s.style.backgroundImage="",s.style.backgroundSize="",s.style.backgroundRepeat="",s.style.backgroundAttachment="",s.style.backgroundPosition="";else if(t==="custom"){const r=Is();r?(s.style.backgroundImage=`url(${r})`,s.style.backgroundSize="cover",s.style.backgroundRepeat="no-repeat",s.style.backgroundAttachment=a,s.style.backgroundPosition="center"):s.style.backgroundImage=""}else{const r=Qe[t];s.style.backgroundImage=`url(${r})`,s.style.backgroundSize="cover",s.style.backgroundRepeat="no-repeat",s.style.backgroundAttachment=a,s.style.backgroundPosition="center"}localStorage.setItem(He,t)}function Ls(){const s=Ze()??(nt()?"dark":"light");ue(s);const n=Es()??"indigo";at(n);const a=et()??"none";rt(a);const r=tt()??"classic";st(r)}function it(t){let s=t.trim();if(s.startsWith("#")||(s=`#${s}`),s.length===4){const n=s[1],a=s[2],r=s[3];s=`#${n}${n}${a}${a}${r}${r}`}return s}function Cs(t,s){const n=it(t).slice(1),a=parseInt(n,16);let r=a>>16&255,l=a>>8&255,i=a&255;r=Math.max(0,Math.min(255,Math.round(r+255*s))),l=Math.max(0,Math.min(255,Math.round(l+255*s))),i=Math.max(0,Math.min(255,Math.round(i+255*s)));const o=u=>u.toString(16).padStart(2,"0");return`#${o(r)}${o(l)}${o(i)}`}function ve(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid"||t==="beta")return t}try{return tt()??"classic"}catch{return"classic"}}function Z(){const[t,s]=c.useState(()=>ve());c.useEffect(()=>{const a=()=>{const i=ve();s(o=>o===i?o:i)},r=i=>{const o=i.detail;o==="classic"||o==="liquid"||o==="beta"?s(o):a()};window.addEventListener("stylemodechange",r);const l=new MutationObserver(a);return l.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",r),l.disconnect()}},[]);const n=c.useCallback(a=>{st(a),s(a)},[]);return[t,n]}function F(t){return`${"/betatestik/".replace(/\/$/,"")}${t}`}function As(){if(!us("cmd_palette",!0))return null;const[s]=Z(),[n,a]=c.useState(!1),[r,l]=c.useState(""),[i,o]=c.useState(0),[u,f]=c.useState(()=>localStorage.getItem("cp_filter")||"all");c.useEffect(()=>{try{localStorage.setItem("cp_filter",u)}catch{}},[u]),c.useEffect(()=>{function d(g){(g.ctrlKey||g.metaKey)&&g.key.toLowerCase()==="k"&&(g.preventDefault(),a(!0),l(""),o(0)),n&&g.key==="Escape"&&a(!1)}return window.addEventListener("keydown",d),window.openCommandPalette=()=>{a(!0),l(""),o(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",d)}},[n]);const x=c.useMemo(()=>{const d=[];d.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Страница",url:F("/favorites")}),d.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Страница",url:F("/settings")});for(const m of ns)d.push({kind:"role",id:m.id,title:m.role,subtitle:"Раздел",url:F(`/roles/${m.id}`)});for(const m of ye)d.push({kind:"law",id:m.slug,title:m.title,subtitle:"Закон",url:F(`/laws/${m.slug}`)});for(const m of rs)d.push({kind:"vu",id:m.id,title:m.title,subtitle:"ВУ",url:F(`/vu/${m.id}`)});const g=r.trim().toLowerCase();return g&&d.push(...E(g).slice(0,60)),g?(u==="all"?d:d.filter(m=>m.kind===u)).map(m=>({r:m,score:S(`${m.title} ${m.subtitle||""}`.toLowerCase(),g)+(m.__boost||0)})).filter(m=>m.score>0).sort((m,y)=>y.score-m.score).slice(0,30).map(m=>m.r):d.slice(0,20)},[r,u]);function S(d,g){return g.split(/\s+/).filter(Boolean).reduce((m,y)=>m+(d.includes(y)?1:0),0)}function E(d){const g=[],h=y=>y.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const y of ye){const v=(y.content||"").replace(/\r\n?/g,`
`).split(`
`);let R="",z="";const k=new Set;for(const M of v){const I=M.trim(),B=/^(#{2,6})\s*(.+)$/.exec(I);if(B){R=B[2].trim(),z=h(R)||"";const P=R.toLowerCase();if(z&&P.includes(d)){const $=`${y.slug}#${z}`;if(!k.has($)){const _={kind:"law",id:$,title:`${y.title} — ${R}`,subtitle:"Заголовок",url:F(`/laws/${y.slug}?q=${encodeURIComponent(d)}#${z}`)};_.__boost=P.startsWith(d)?8:6,g.push(_),k.add($)}}continue}if(I&&I.toLowerCase().includes(d)){const P=z?`${y.slug}#${z}`:y.slug;if(!k.has(P)){const $=I.length>140?I.slice(0,137)+"…":I,_=z?`${y.title} — ${R}`:y.title,dt=F(z?`/laws/${y.slug}?q=${encodeURIComponent(d)}#${z}`:`/laws/${y.slug}?q=${encodeURIComponent(d)}`),me={kind:"law",id:P,title:_,subtitle:$||"Контекст",url:dt};me.__boost=5,g.push(me),k.add(P)}}}}const m=new Set;return g.filter(y=>m.has(y.id)?!1:(m.add(y.id),!0))}function b(d){a(!1);try{window.location.href=d}catch{location.assign(d)}}function p(d){x.length&&(d.key==="ArrowDown"&&(d.preventDefault(),o(g=>Math.min(g+1,x.length-1))),d.key==="ArrowUp"&&(d.preventDefault(),o(g=>Math.max(g-1,0))),d.key==="Enter"&&(d.preventDefault(),b(x[i].url)))}const j=({children:d})=>s==="liquid"?e.jsx(W,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:d}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:d});return e.jsx(e.Fragment,{children:n?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Поиск",children:e.jsxs(j,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(ce,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:r,onChange:d=>{l(d.target.value),o(0)},onKeyDown:p,placeholder:"Поиск: закон, роль, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>a(!1),"aria-label":"Закрыть",children:e.jsx(Ie,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(d=>e.jsx("button",{onClick:()=>{f(d.k),o(0)},className:`chip ${u===d.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:d.label},d.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!x.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),x.map((d,g)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${g===i?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>o(g),onClick:()=>b(d.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[d.kind==="law"&&e.jsx(G,{className:"h-4 w-4"}),d.kind==="role"&&e.jsx(J,{className:"h-4 w-4"}),d.kind==="vu"&&e.jsx(le,{className:"h-4 w-4"}),d.kind==="page"&&(d.id==="settings"?e.jsx(de,{className:"h-4 w-4"}):e.jsx(X,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:d.title})]}),d.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:d.subtitle})]},`${d.kind}:${d.id}`))]})]})}):null})}const K={},Rs=(K==null?void 0:K.VITE_API_BASE)||(K==null?void 0:K.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function Ps(){try{const t="anon_uid";let s=localStorage.getItem(t);return s||(s=crypto.randomUUID(),localStorage.setItem(t,s)),s}catch{return"na"}}function $s(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:Ps()}}function Ts(t,s){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const r=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(r)==="1"||String(r)==="yes")return}catch{}const n=JSON.stringify({event:t,...$s(),data:s}),a=`${Rs}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const r=new Blob([n],{type:"application/json"});if(navigator.sendBeacon(a,r))return}catch{}try{fetch(a,{method:"POST",headers:{"content-type":"application/json"},body:n})}catch{}}const ke="recent:items";function Ds(t,s){try{const n=localStorage.getItem(ke),a=n?JSON.parse(n):[],r={url:t,title:s,ts:Date.now()};if(a.length&&a[0].url===t)return;const l=a.filter(u=>u.url!==t);l.unshift(r);const i=[],o=new Set;for(const u of l)o.has(u.url)||(o.add(u.url),i.push(u));for(;i.length>15;)i.pop();localStorage.setItem(ke,JSON.stringify(i))}catch{}}const ot=[{key:"home",type:"route",label:"Главная",icon:e.jsx(_t,{className:"h-4 w-4"}),to:"/home"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(J,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(Mt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(Lt,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx(Ct,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(Y,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(At,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(G,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(le,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(G,{className:"h-4 w-4"}),id:"laws"}];function Bs(){const[t,s]=c.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),n=H(),[a]=Z(),r=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),l=c.useMemo(()=>{const j=(new URLSearchParams(n.search||"").get("tab")||"").toLowerCase(),d=(n.hash||"").replace(/^#/,"").toLowerCase();return j||d||""},[n.search,n.hash]),i=c.useCallback(p=>l===p,[l]);c.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const j=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=j}}},[t]),c.useEffect(()=>{function p(){typeof window>"u"||s(window.innerWidth>=1024)}return window.addEventListener("resize",p),()=>window.removeEventListener("resize",p)},[]),c.useEffect(()=>{const p=document.documentElement;t?p.classList.add("has-sidebar"):p.classList.remove("has-sidebar")},[t]);const o=c.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),u=o?"⌘ K":"Ctrl K",f=a==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",w=a==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",x=a==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",S=a==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",E=p=>{const j=`?tab=${encodeURIComponent(p)}`;return r?{pathname:"/",search:j}:{pathname:"/",search:j,hash:`#${p}`}},b=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(A,{to:"/home",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[ot.map(p=>{const j=p.type==="route"?n.pathname===p.to:i(p.id),d=p.type==="route"?p.to:E(p.id);return e.jsx("li",{children:e.jsxs(A,{to:d,className:[f,j?w:""].filter(Boolean).join(" "),"aria-current":j?"page":void 0,"aria-label":p.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&s(!1)},children:[p.icon,e.jsx("span",{className:"truncate",children:p.label})]})},p.key)}),e.jsx("li",{children:e.jsxs(A,{to:"/about",className:f,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&s(!1)},children:[e.jsx(ze,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(A,{to:"/buddy",className:f,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&s(!1)},children:[e.jsx(It,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:x,children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:u}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>s(p=>!p),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:S,children:a==="liquid"?e.jsx(W,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:b}):b})]})}const Fs={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},lt={entities:Fs};function Os(t){var n;return((n=lt.entities)==null?void 0:n[t])||null}function mn(t,s=30){const n=Os(t);if(!(n!=null&&n.updated_at))return{recent:!1};const a=new Date(n.updated_at+"T00:00:00Z");return{recent:(Date.now()-a.getTime())/(1e3*60*60*24)<=s,date:n.updated_at}}function pn(t,s){const n=t.split(/\r?\n/),a=s.split(/\r?\n/),r=n.length,l=a.length,i=Array.from({length:r+1},()=>Array(l+1).fill(0));for(let w=r-1;w>=0;w--)for(let x=l-1;x>=0;x--)i[w][x]=n[w]===a[x]?i[w+1][x+1]+1:Math.max(i[w+1][x],i[w][x+1]);const o=[];let u=0,f=0;for(;u<r&&f<l;)n[u]===a[f]?(o.push(V(n[u])),u++,f++):i[u+1][f]>=i[u][f+1]?(o.push(`<del>${V(n[u])}</del>`),u++):(o.push(`<ins>${V(a[f])}</ins>`),f++);for(;u<r;)o.push(`<del>${V(n[u++])}</del>`);for(;f<l;)o.push(`<ins>${V(a[f++])}</ins>`);return o.join(`
`)}function V(t){return t.replace(/[&<>]/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[s])}function Ks(){var n;const t=[],s=lt.entities||{};for(const[a,r]of Object.entries(s)){const l=(n=r.changelog)==null?void 0:n[0];l&&t.push({id:a,version:l.version,date:l.date,summary:l.summary,details:l.details})}return t.sort((a,r)=>a.date<r.date?1:-1),t}function qs(){const[t]=Z(),s=c.useMemo(()=>{try{const i=Ks()[0];if(!i)return!1;const o=new Date(i.date+"T00:00:00Z");return(Date.now()-o.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function n(){const i=window.openCommandPalette;if(typeof i=="function")try{i();return}catch{}const o=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!o,metaKey:o}))}const a="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",r=t==="liquid"||t==="beta"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",l=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var i;return(i=window.openMobileMenu)==null?void 0:i.call(window)},"aria-label":"Меню",children:e.jsx(Rt,{className:"h-4 w-4"})}),e.jsx(Pt,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:n,"aria-label":"Поиск",children:[e.jsx(ce,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(A,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(A,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(X,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(A,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(de,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(Y,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]});return e.jsx("div",{className:r,children:t==="liquid"?e.jsx(W,{className:`${a} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:l}):e.jsx("div",{className:a,children:l})})}const Vs="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",re="notif:lastSeen",Ne="notifications-panel";function Ws(){const[t,s]=c.useState(!1),[n,a]=c.useState([]),[r,l]=c.useState(0),[i,o]=c.useState(!1),[u,f]=c.useState(null),w=c.useRef(null),x=c.useCallback(async()=>{const b=new AbortController;o(!0),f(null);try{const p=await fetch(Vs,{cache:"no-store",signal:b.signal});if(!p.ok)throw new Error(`HTTP ${p.status}`);const j=await p.json(),d=Array.isArray(j)?j:j.items||[],g=N=>N?new Date(N).getTime():0;d.sort((N,v)=>g(v.date)-g(N.date)),a(d);const h=typeof localStorage<"u"&&localStorage.getItem(re)||"",m=h?d.findIndex(N=>N.id===h):-1,y=m===-1?d.length:m;l(Math.max(0,y))}catch(p){(p==null?void 0:p.name)!=="AbortError"&&f("Не удалось загрузить уведомления")}finally{o(!1)}return()=>b.abort()},[]);c.useEffect(()=>{x()},[x]),c.useEffect(()=>{if(t&&n.length)try{localStorage.setItem(re,n[0].id),l(0)}catch{}},[t,n]),c.useEffect(()=>{if(!t)return;const b=j=>{w.current&&(w.current.contains(j.target)||s(!1))},p=j=>{j.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",p)}},[t]);const S=()=>s(b=>!b),E=b=>b?new Date(b).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:w,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:S,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":Ne,children:[e.jsx($t,{className:"h-4 w-4"}),r>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:r})]}),t&&e.jsxs(W,{id:Ne,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),i?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):u?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:u}):n.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:n.map(b=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:b.url||"#",target:b.url?"_blank":void 0,rel:b.url?"noreferrer":void 0,onClick:()=>{var p;try{(p=n[0])!=null&&p.id&&localStorage.setItem(re,n[0].id),l(0)}catch{}},children:[b.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:b.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:b.text}),b.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:E(b.date)})]})},b.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function Us(){const[t,s]=c.useState(!1),n=H();c.useEffect(()=>(window.openMobileMenu=()=>s(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),c.useEffect(()=>{if(!t)return;const i=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=i}},[t]);const a=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),r=i=>{const o=new URLSearchParams(n.search||"");o.set("tab",i);const u=`?${o.toString()}`;return a?{pathname:"/",search:u}:{pathname:"/",search:u,hash:`#${i}`}};function l(){const i=window.openCommandPalette;if(typeof i=="function")try{i()}catch{}s(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>s(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:l,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(ce,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>s(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(Ie,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:ot.map(i=>{const o=i.type==="route"?i.to:r(i.id);return e.jsx("li",{children:e.jsxs(A,{to:o,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>s(!1),children:[i.icon,e.jsx("span",{className:"truncate",children:i.label})]})},i.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(A,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(X,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(A,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(de,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const ie=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!"];function Gs(){const[t,s]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const n=window.matchMedia("(prefers-reduced-motion: reduce)"),a=r=>s(r.matches);return s(n.matches),typeof n.addEventListener=="function"?n.addEventListener("change",a):n.addListener&&n.addListener(a),()=>{typeof n.removeEventListener=="function"?n.removeEventListener("change",a):n.removeListener&&n.removeListener(a)}},[]),t}function Hs(){const[t,s]=c.useState(null),n=c.useRef(Math.floor(Math.random()*ie.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches)return null;const a=Gs(),r=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),l=!a&&!r,i=c.useRef(null),o=c.useRef(null);c.useEffect(()=>{const S=i.current;if(!S)return;let E=0,b=performance.now(),p=Math.random()*(window.innerWidth-64)+16,j=Math.random()*(window.innerHeight-120)+60,d=(Math.random()*60+30)*(Math.random()>.5?1:-1),g=(Math.random()*40+20)*(Math.random()>.5?1:-1);const h=y=>{const N=Math.min(.05,(y-b)/1e3);if(b=y,l){p+=d*N,j+=g*N;const v=16,R=window.innerWidth,z=window.innerHeight,k=48,M=48;p<v&&(p=v,d=Math.abs(d)),p>R-k-v&&(p=R-k-v,d=-Math.abs(d)),j<60&&(j=60,g=Math.abs(g)),j>z-M-v&&(j=z-M-v,g=-Math.abs(g)),d+=(Math.random()-.5)*4,g+=(Math.random()-.5)*4}S.style.transform=`translate3d(${Math.round(p)}px, ${Math.round(j)}px, 0)`,E=requestAnimationFrame(h)};E=requestAnimationFrame(h);const m=()=>{b=performance.now()};return window.addEventListener("resize",m),()=>{cancelAnimationFrame(E),window.removeEventListener("resize",m)}},[l]);function u(S){const E=S??ie[n.current++%ie.length];s(E),window.clearTimeout(u._t),u._t=window.setTimeout(()=>s(null),3e3)}function f(S){u()}function w(){o.current&&window.clearTimeout(o.current),o.current=window.setTimeout(()=>u("Просто нажми, чтобы я говорил!"),600)}function x(){o.current&&(window.clearTimeout(o.current),o.current=null)}return e.jsx("div",{ref:i,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:f,onPointerDown:w,onPointerUp:x,onPointerLeave:x,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:"#bcd3ff",stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:"#6a79ff",stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}c.lazy(()=>T(()=>import("./GovCheatsheetSky-DAM4pDiW.js"),__vite__mapDeps([0,1,2,3,4])));const Ys=c.lazy(()=>T(()=>import("./WhatsNew-p258BbBD.js"),__vite__mapDeps([5,1,2]))),Xs=c.lazy(()=>T(()=>import("./DiffPage-D7iYesNp.js"),__vite__mapDeps([6,1,2]))),Js=c.lazy(()=>T(()=>import("./LiquidGlassShowcase-C6z-Buym.js"),__vite__mapDeps([7,1,2]))),Qs=c.lazy(()=>T(()=>import("./PrintSheet-DPt895i7.js"),__vite__mapDeps([8,1,2]))),Zs=c.lazy(()=>T(()=>import("./RolePage-GqB__Iha.js"),__vite__mapDeps([9,1,3,2,10]))),en=c.lazy(()=>T(()=>import("./LawPage-CIFfSM47.js"),__vite__mapDeps([11,1,10,2]))),tn=c.lazy(()=>T(()=>import("./VuPage-C1zG0njd.js"),__vite__mapDeps([12,1,2]))),sn=c.lazy(()=>T(()=>import("./BuddyPlayground-D4gGuPEP.js"),__vite__mapDeps([13,1,2]))),nn=c.lazy(()=>T(()=>import("./SettingsPage-CvQVJydu.js"),__vite__mapDeps([14,1,4,2]))),an=c.lazy(()=>T(()=>import("./FavoritesPage-Du4ac1W5.js"),__vite__mapDeps([15,1,10,2])));function rn(){const t=H();return c.useEffect(()=>{try{Ts("page_view")}catch{}try{Ds(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function on(){return(H().pathname||"").startsWith("/buddy")?null:e.jsx(Hs,{})}function ln(){const[t]=Z();return e.jsxs("div",{className:"min-h-dvh w-full",children:[(t==="liquid"||t==="beta")&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:t==="beta"?"radial-gradient(900px 600px at 10% -5%, rgba(0,255,240,.16), transparent 60%),radial-gradient(1100px 780px at 92% 8%, rgba(168,85,247,.18), transparent 65%),linear-gradient(180deg, rgba(255,255,255,.03), rgba(0,0,0,.45))":"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:t==="beta"?.02:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(ht,{basename:"/betatestik/",children:[e.jsx(As,{}),e.jsx(Bs,{}),e.jsx(qs,{}),e.jsx(Us,{}),e.jsx(on,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(Ws,{})}),e.jsx(rn,{}),e.jsx(c.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Загрузка…"}),children:e.jsxs(xt,{children:[e.jsx(L,{path:"/",element:e.jsx(Jt,{})}),e.jsx(L,{path:"/home",element:e.jsx(pe,{to:"/",replace:!0})}),e.jsx(L,{path:"/whats-new",element:e.jsx(Ys,{})}),e.jsx(L,{path:"/diff/:id",element:e.jsx(Xs,{})}),e.jsx(L,{path:"/print",element:e.jsx(Qs,{})}),e.jsx(L,{path:"/roles/:id",element:e.jsx(Zs,{})}),e.jsx(L,{path:"/laws/:slug",element:e.jsx(en,{})}),e.jsx(L,{path:"/vu/:id",element:e.jsx(tn,{})}),e.jsx(L,{path:"/recorders/:id",element:e.jsx(es,{})}),e.jsx(L,{path:"/about",element:e.jsx(ss,{})}),e.jsx(L,{path:"/style/liquid",element:e.jsx(Js,{})}),e.jsx(L,{path:"/buddy",element:e.jsx(sn,{})}),e.jsx(L,{path:"/settings",element:e.jsx(nn,{})}),e.jsx(L,{path:"/favorites",element:e.jsx(an,{})}),e.jsx(L,{path:"*",element:e.jsx(pe,{to:"/",replace:!0})})]})})]})]})}(function(){try{const s="app:version",n=localStorage.getItem(s),a="1758309299799";if(n&&n!==a){"caches"in window?caches.keys().then(r=>Promise.all(r.map(l=>caches.delete(l)))).finally(()=>{localStorage.setItem(s,a),location.reload()}):(localStorage.setItem(s,a),location.reload());return}localStorage.setItem(s,a)}catch{}})();Ls();js();function ct(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}ct();window.addEventListener("resize",ct,{passive:!0});oe.createRoot(document.getElementById("root")).render(e.jsx(c.StrictMode,{children:e.jsx(ln,{})}));export{Je as A,os as B,ts as C,ps as D,xs as E,Qe as F,cs as G,fs as H,W as L,ns as a,Os as b,Es as c,pn as d,tt as e,ls as f,Ks as g,ds as h,mn as i,e as j,hs as k,ye as l,gs as m,bs as n,ks as o,_s as p,ue as q,Qt as r,nt as s,st as t,Z as u,rs as v,vs as w,Ms as x,at as y,un as z};
